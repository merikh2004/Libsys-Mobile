...
const Header = () => {
  ...
  return (
    <View style={{ zIndex: 1000 }}>
      <SafeAreaView className="bg-white shadow-sm" edges={['top']}>
      ...
      {isMenuVisible && (
        <>
          ...
          <View 
            className="absolute top-[75px] right-4 bg-white rounded-2xl p-4 shadow-2xl border border-slate-100 z-[1001] w-[240px]"
            style={{ 
              elevation: 10,
              shadowColor: '#000',
...
const styles = StyleSheet.create({
  backdrop: {
    ...
    left: 0,
    right: 0,
    bottom: -1000, // Extend backdrop way below to cover the whole screen
